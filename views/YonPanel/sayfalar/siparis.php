	...
	?>
      	...
      	<!-- SİPARİŞİN İSKELETİ BAŞLIYOR -->
        		 <div class="row arkaplan p-1 mt-2 pb-0">
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-12 col-sm-12 geneltext bg-gradient-mvc" class="d-flex gap-10" id="detaygoster">
    <div class="d-flex" style="gap: 10px;">
        <a class="btn btn-success" data-value="<?php echo $value["siparis_no"]; ?>" data-value2="<?php echo $value["adresid"]; ?>" data-toggle="modal" data-target="#exampleModalCenter" href="">
