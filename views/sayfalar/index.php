...
<div class="banner-bottom">
	...
	<div class="clearfix"> </div>
		...
		<div class="container">
			...
			<li><a href="<?php echo URL; ?>/urunler/detay/<?php  echo $value2["id"]; ?>/<?php  echo $Harici->seo($value2["urunad"]); ?>"><img src="<?php echo URL; ?>/views/design/images/<?php  echo $value2["res1"]; ?>" class="img-responsive" alt="<?php  echo $value2["urunad"]; ?>" /></a>
